...
void probe_devices(i2c_master_bus_handle_t bus_handle) {
    ...
    nightglass::core::health_registry().set("rtc", rtc_added ? nightglass::core::HealthState::degraded
    ...
    nightglass::core::health_registry().set("pmic", pmic_identified
    ...
    portEXIT_CRITICAL(&snapshot_mux);
    nightglass::core::health_registry().set(
        "haptic", haptic_ready ? nightglass::core::HealthState::ok
...
nightglass::core::Status HardwareService::start(i2c_master_bus_handle_t bus_handle) {
    if (!bus_handle) return {nightglass::core::StatusCode::invalid_state, "I2C bus unavailable"};
    if (service_task) return nightglass::core::Status::Ok();
    ...
    portEXIT_CRITICAL(&snapshot_mux);
    nightglass::core::health_registry().set(
        "haptic", haptic_output_ready ? nightglass::core::HealthState::degraded
                                       : nightglass::core::HealthState::failed,
    ...
    if (xTaskCreatePinnedToCore(hardware_task, "hardware_service", 6144, bus_handle,
        ...
        gpio_set_level(kHapticGpio, 0);
        return {nightglass::core::StatusCode::no_memory, "hardware task creation failed"};
    }
